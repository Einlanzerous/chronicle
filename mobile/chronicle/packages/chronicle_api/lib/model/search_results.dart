...
class SearchResults {
  ...
  /// The cap the answer was clamped to.
  int limit;

  /// Best first. Not a page of anything.
  ...
  @override
  String toString() => 'SearchResults[query=$query, limit=$limit, items=$items]';
  ...
  static SearchResults? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'query'), 'Required key "SearchResults[query]" is missing from JSON.');
        assert(json[r'query'] != null, 'Required key "SearchResults[query]" has a null value in JSON.');
        assert(json.containsKey(r'limit'), 'Required key "SearchResults[limit]" is missing from JSON.');
        assert(json[r'limit'] != null, 'Required key "SearchResults[limit]" has a null value in JSON.');
        assert(json.containsKey(r'items'), 'Required key "SearchResults[items]" is missing from JSON.');
        assert(json[r'items'] != null, 'Required key "SearchResults[items]" has a null value in JSON.');
        return true;
      }());
      ...
      return SearchResults(
        ...
        items: SearchHit.listFromJson(json[r'items']),
      );
    }
    return null;
  }
